...
export const messages = {
  en: { common: commonEn, nav: navEn, dashboard: dashboardEn, careers: careersEn, sectors: sectorsEn, skills: skillsEn, global: globalEn, sources: sourcesEn, heatmap: heatmapEn, explore: exploreEn },
  zh: { common: commonZh, nav: navZh, dashboard: dashboardZh, careers: careersZh, sectors: sectorsZh, skills: skillsZh, global: globalZh, sources: sourcesZh, heatmap: heatmapZh, explore: exploreZh },
} as const;
